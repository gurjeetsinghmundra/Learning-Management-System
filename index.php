<?php
  ...
  <h1 class="my-content">Learning Management System</h1>
  
  <small class="my-content">Guru Nanak Khalsa College of Arts, Science & Commerce, Mumbai.</small><br>
    ...
    <div class="container-fluid bg-danger txt-banner"> <!-- Start Text Banner -->
        <div class="row bottom-banner">
          <div class="col-sm">
            <h5> <i class="fas fa-book-open mr-3"></i> Online Learning</h5>
          </div>
          <div class="col-sm">
          ...
          <div class="col-sm">
            <h5><i class="fas fa-rupee-sign mr-3"></i> Online Payment</h5>
          </div>
        </div>
    </div> <!-- End Text Banner -->
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>GnKhalsa provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>Nathalal Parekh Marg,  <br> Matunga East, Mumbai, <br> Maharashtra 400019 <br> Phone: +91 1231231231 </p>
          </div>
        </div>
      </div>
